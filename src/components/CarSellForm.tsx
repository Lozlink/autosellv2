...
export default function CarSellForm({ heading, subheading, onStepChange }: CarSellFormProps = {}) {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleRegoConfirmSubmit} className="space-y-3 md:space-y-3">
        <motion.button
          type="submit"
          disabled={loading}
          whileHover={{ scale: 1.01 }}
      ...
      <div className="mt-4 md:mt-6 text-center">
        <p className="text-[11px] md:text-[12px] text-gray-500 flex items-center justify-center gap-1.5 md:gap-2">
          <svg className="w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
          Your information is secure and will not be shared with third parties
        </p>
        <p className="text-[11px] md:text-[12px] text-gray-500 mt-1 flex items-center justify-center gap-2">
