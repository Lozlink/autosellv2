...
export default function Header() {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md shadow-[0_2px_12px_-4px_rgba(15,23,42,0.08)] sticky top-0 z-50 text-gray-700 border-b border-[rgba(255,195,37,0.45)]">
      <GoogleReviewsBadge />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center py-5 gap-8">
          ...
          <nav className="hidden lg:flex flex-1 items-center space-x-5">
            ...
            <Link
              href="/#sell-form"
              className="btn-pill-gold px-4 py-2 text-xs"
            >
              Get Free Quote
            </Link>
          </nav>
        ...
        {isMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-1 text-gray-700">
                ...
                <a
                    href="tel:0492858699"
                    className="btn-pill-outline px-6 py-3 mt-3 w-full"
                    onClick={() => setIsMenuOpen(false)}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                ...
                <Link
                    href="/#sell-form"
                    className="btn-pill-gold px-6 py-3 w-full"
                    onClick={() => setIsMenuOpen(false)}
                >
                  Get Free Quote
                </Link>
