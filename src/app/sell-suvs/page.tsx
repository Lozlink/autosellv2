...
export const metadata: Metadata = {
  ...
  description: "Sell your SUV fast with a 30-min quote, fair valuation and same-day OSKO payment. Auto-Sell.ai offers Australia-wide pickup for a simple, stress-free sale.",
