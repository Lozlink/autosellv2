...
const SLUG = 'sell-volkswagen'
const D = PAGE_COPY_DEFAULTS['sell-volkswagen']
...
export default async function SellVolkswagenPage() {
  const b = await getPageOverrides(SLUG)
  return (
            ...
            <div className="order-1 lg:order-2">
              <div className="liquid-glass-form-container rounded-2xl shadow-xl">
                <Suspense fallback={<div className="rounded-2xl p-8 border bg-white/30 animate-pulse h-96" style={{ borderColor: '#FFC325' }}></div>}>
                  <OfferForm heading="Sell Your Volkswagen" subheading="Get Your Free Quote Now" />
                </Suspense>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
            <p className="text-gray-800">
              {text(b, 'pricing_closing', D.pricing_closing)}
            </p>
          </div>
        </div>
      </section>
