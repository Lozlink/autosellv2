          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-5 hidden lg:block">
                <Link href="tel:1800Auto-Sell" className="flex items-center gap-4 group">
                ...
                <Link href="sms:1800Auto-Sell" className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgba(255, 195, 37, 0.1)' }}>
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: '#FFC325' }}>
      ...
      <section className="py-12 bg-white lg:hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-6">
            <Link href="tel:1800Auto-Sell" className="text-center p-6 rounded-xl border border-[#FFC325] hover:shadow-lg transition-shadow">
            ...
            <Link href="sms:1800Auto-Sell" className="text-center p-6 rounded-xl border border-[#FFC325] hover:shadow-lg transition-shadow">
              <svg className="w-8 h-8 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: '#FFC325' }}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
