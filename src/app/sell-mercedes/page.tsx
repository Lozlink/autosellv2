...
const SLUG = 'sell-mercedes'
const D = PAGE_COPY_DEFAULTS['sell-mercedes']
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: 'https://www.auto-sell.ai/sell-mercedes',
    },
  }
}

export default async function SellMercedesPage() {
  const b = await getPageOverrides(SLUG)
            ...
            <div className="order-1 lg:order-2">
              <div className="liquid-glass-form-container rounded-2xl shadow-xl">
                <Suspense fallback={<div className="rounded-2xl p-8 border bg-white/30 animate-pulse h-96" style={{ borderColor: '#FFC325' }}></div>}>
                  <OfferForm heading="Sell Your Mercedes" subheading="Get Your Free Quote Now" />
                </Suspense>
              </div>
            </div>
          </div>
