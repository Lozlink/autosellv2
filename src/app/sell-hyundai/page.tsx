...
const SLUG = 'sell-hyundai'
const D = PAGE_COPY_DEFAULTS['sell-hyundai']
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: 'https://www.auto-sell.ai/sell-hyundai',
    },
  }
}

export default async function SellHyundaiPage() {
  const b = await getPageOverrides(SLUG)
  return (
